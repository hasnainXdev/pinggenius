      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <UseCaseCard
            ...
            message={`Hi [Name], I noticed your recent investment in [Company] and your focus on B2B SaaS. Our AI-powered sales tool is seeing 40% month-over-month growth with similar portfolio companies like [Portfolio Company]. Would love to share our Series A deck—do you have 15 minutes this week?`}
          ...
          <UseCaseCard
            ...
            message={`Hey [Name], saw your tweet about struggling with [Pain Point]. I built [Product Name] specifically to solve this—it's helped 200+ indie makers like yourself save 10+ hours per week. Mind if I send over a quick demo?`}
